...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="pesquisa.php">Tabela de Produtos</a>
            <a href="../pessoas/pesquisa.php">Tabela de Usuarios</a>
        </nav>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="pesquisa.php" style="color: #46278e;" onmouseover="this.style.color='#231641b3'" onmouseout="this.style.color='#46278e'">Tabela de Produtos</a>
            <a href="../pessoas/pesquisa.php" style="color: #46278e;" onmouseover="this.style.color='#231641b3'" onmouseout="this.style.color='#46278e'">Tabela de Usuarios</a>
        </nav>
    </aside>
    <!-- ---------------------------------SLIDE------------------------------------------------------------------------------ -->
