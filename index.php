...
include "produtos/conexao_produto.php";
...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            <a href="pessoas/cadastro.php">Cadastrar-se</a>
            <a href="#">Sobre</a>
            <a href="#">Serviços</a>
            <a href="#">Contato</a>
        </nav>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="pessoas/cadastro.php" style="color: #46278e;" onmouseover="this.style.color='#231641b3'" onmouseout="this.style.color='#46278e'">Cadastrar-se</a>
